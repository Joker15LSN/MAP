...
# P0-SEC-01: no hardcoded credentials in the repository. The production URI
# (including its password) MUST be injected via environment; an unset value
# fails closed (empty URI cannot connect).
MONGODB_CONFIG = {
