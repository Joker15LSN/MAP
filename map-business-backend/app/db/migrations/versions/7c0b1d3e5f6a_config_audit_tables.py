...
def upgrade() -> None:
    ...
    op.create_index('ix_audit_events_created', 'config_audit_events', ['created_at'], schema='map_control')
    op.create_index('ix_audit_events_resource', 'config_audit_events', ['resource_type', 'resource_id'], schema='map_control')
    op.create_index('ix_audit_events_actor', 'config_audit_events', ['actor_user_id'], schema='map_control')
    op.create_index('ix_audit_events_status', 'config_audit_events', ['status'], schema='map_control')
    ...
    op.create_index('ix_config_mutations_status', 'config_mutations', ['status'], schema='map_control')
...
def downgrade() -> None:
    ...
    op.drop_index('ix_audit_events_resource', table_name='config_audit_events', schema='map_control')
